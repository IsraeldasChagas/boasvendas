...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Estas linhas contêm as mensagens de validação predefinidas usadas pelo
    ...
    */
    ...
    'extensions' => 'O campo :attribute deve ser um ficheiro com uma das extensões: :values.',
    ...
    'missing_unless' => 'O campo :attribute deve estar ausente salvo se :other for :value.',
    ...
    'present_unless' => 'O campo :attribute deve estar presente salvo se :other for :value.',
    ...
    'required_unless' => 'O campo :attribute é obrigatório salvo se :other estiver em :values.',
    ...
    'uploaded' => 'O envio do ficheiro :attribute falhou.',
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Estas linhas permitem substituir o nome técnico do campo (:attribute)
