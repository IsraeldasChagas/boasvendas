    ...
    <div class="vf-card p-4" style="max-width: 40rem;">
        <form action="{{ route('admin.empresas.update', $empresa) }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('modulos_resumo') is-invalid @enderror" id="modulos_resumo" name="modulos_resumo" value="{{ old('modulos_resumo', $empresa->modulos_resumo) }}">
