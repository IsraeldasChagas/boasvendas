...
use App\Http\Controllers\Empresa\InsumoController;
...
Route::get('/media/produto-ingrediente/{produtoIngrediente}', [PublicoController::class, 'produtoIngredienteFoto'])
...
Route::middleware(['auth', 'empresa.painel', 'empresa.colaborador', 'empresa.menu'])->prefix('empresa')->name('empresa.')->group(function () {
    ...
    Route::get('/estoque/{produto}/ficha-tecnica', [EstoqueController::class, 'ficha'])->name('estoque.ficha');
    Route::put('/estoque/{produto}/ficha-tecnica', [EstoqueController::class, 'fichaCabecalho'])->name('estoque.ficha.cabecalho');
    Route::post('/estoque/{produto}/ficha-tecnica/itens', [EstoqueController::class, 'fichaStore'])->name('estoque.ficha.store');
    Route::put('/estoque/{produto}/ficha-tecnica/itens/{fichaItem}', [EstoqueController::class, 'fichaUpdate'])->name('estoque.ficha.update');
    Route::delete('/estoque/{produto}/ficha-tecnica/itens/{fichaItem}', [EstoqueController::class, 'fichaDestroy'])->name('estoque.ficha.destroy');
    ...
    Route::get('/insumos/{insumo}/movimentos', [InsumoController::class, 'movimentos'])->name('insumos.movimentos');
    Route::post('/insumos/{insumo}/repor', [InsumoController::class, 'repor'])->name('insumos.repor');
    Route::post('/insumos/{insumo}/ajustar', [InsumoController::class, 'ajustar'])->name('insumos.ajustar');
